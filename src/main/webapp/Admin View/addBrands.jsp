...
<body>	
	...
	<section id="sidebar">
		...
		<ul class="side-menu">
            ...
            <li>
				<a href="#"><i class='bx bxs-inbox icon'></i>All Brands<i class='bx bx-chevron-right icon-right' ></i></a>
	...
	<section id="content">
		...
		<!-- MAIN -->
		<main>
			<h1 class="title">Add Brands</h1>
			<ul class="breadcrumbs">
				<li><a href="#">Brands</a></li>
				<li class="divider">/</li>
				<li><a href="#" class="active">Add Brands</a></li>
			</ul>
			
			<div class="info-data">
			<div class="card">     
			     <div class="container">
			      <h1 class="headAdd">Add Brand</h1>
			      
			      <form action="${pageContext.request.contextPath}/AdminAddBrands" method="post" enctype="multipart/form-data">
			      
			        <label for="brand-name" class="labelAdd">Brand Name:</label>
			        <input type="text" id="brand-name" name="brand-name" >
			        
			        <label for="product-image3" class="labelAdd" style="margin-bottom: 40px;">Brand Logo:</label>
			        <input type="file" id="product-image3" name="brand_logo" />

			        <button type="submit" class="btnAdd">Add Brand</button>
			      </form>
    			</div>
			</div>
			</div> 
